...
// Add cursor follow effect for desktop
...
// Add smooth reveal on scroll for section titles
...
console.log('%c🎨 Gizo Studio', 'font-size: 40px; font-weight: bold; background: linear-gradient(135deg, #D4FF00, #b8e000); -webkit-background-clip: text; color: transparent;');
console.log('%cDesigned with ❤️ by Gizo Studio', 'font-size: 14px; color: #D4FF00;');
